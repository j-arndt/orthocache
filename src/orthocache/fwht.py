...
def fwht_512(x: jax.Array) -> jax.Array:
    ...
    suitable for JAX/Pallas kernel compilation.
    
    Args:
        x: A JAX array of shape (512, d) or (512,).
        
    Returns:
        The transformed JAX array, normalized by 1 / sqrt(512).
    """
    n = 512
    is_1d = x.ndim == 1
    if is_1d:
