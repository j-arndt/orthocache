"""Tests for orthocache.ici_bandwidth_model.

Validates the pure-analytical ICI bandwidth model:
1. ici_bytes_per_step — formula correctness and edge cases.
2. ici_bandwidth_table — table generation with correct structure.
3. model_configs — pre-defined configs have required keys.
...
from orthocache.ici_bandwidth_model import (
    ici_bytes_per_step,
    ici_bandwidth_table,
    model_configs,
...
class TestICIBytesPerStep:
    """Tests for the core ICI transfer volume computation."""
    ...
    def test_formula_matches_manual(self):
        """Verify the formula: dense = L * S * d_k * H_kv * dtype / P^2."""
...
class TestModelConfigs:
    ...
    def test_known_models_present(self):
        """Expected model names should exist."""
